// fitness.ts
// Web-safe base version — no native health kit imports.
// On native, fitness.native.ts is automatically selected by Metro instead.
// On web, this file (or fitness.web.ts) is used — both are web-safe.
